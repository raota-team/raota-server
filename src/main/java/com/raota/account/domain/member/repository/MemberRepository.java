package com.raota.account.domain.member.repository;
...
""")
    ...
    @Query("""
    select new com.raota.account.presentation.member.response.MyProfileResponse(
        m.id,
        m.nickname,
        m.email,
        m.imageUrl,
        ...
        m.bio,
        new com.raota.account.presentation.member.response.UserStatsDto(
        ...
        new com.raota.account.presentation.member.response.ActivityVisibilityResponse(
...
""")
    ...
    @Query(value = """
            select new com.raota.account.presentation.member.response.VisitSummaryResponse(
                r.id,
                r.name,
                r.imageUrl,
    ...
    @Query(value = """
            select new com.raota.account.presentation.member.response.BookmarkSummaryResponse(
                r.id,
                r.name,
                r.imageUrl,
    ...
    @Query(value = """
    select new com.raota.account.presentation.member.response.PhotoSummaryResponse(
        p.id,
        p.imageUrl,
        p.menuName,
        p.note,
