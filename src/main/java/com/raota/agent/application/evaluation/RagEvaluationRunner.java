 ...
 *
 * <p>
 * The runner is asynchronous in the default implementation, while callers only depend on
 * the execution contract and do not need to know its scheduling or persistence details.
 * </p>
 */
