...
public class SpringAiRamenShopComparisonNarrativeAdapter implements RamenShopComparisonNarrativePort {
    ...
    public SpringAiRamenShopComparisonNarrativeAdapter(ChatClient.Builder chatClientBuilder,
    ...
    @Override
    public AiRamenShopComparisonResult generateComparisonNarratives(String focus, String contextA, String contextB) {
        try {
