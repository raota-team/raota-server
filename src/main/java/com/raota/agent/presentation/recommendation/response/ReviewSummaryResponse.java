...
public record ReviewSummaryResponse(AiShopBasicInfo shopInfo, Integer reviewCount, AiSummary summary,
        List<SampleReview> sampleReviews) {
    public record AiShopBasicInfo(Long id, String name, String type, String location, String imageUrl,
