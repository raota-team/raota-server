package com.raota.web.community.domain.model;
...
public class Post {
     ...
     * 새로운 커뮤니티 게시글을 생성한다.
     */
    public static Post create(PostCategory category, String title, String content, String contentFormat,
            String thumbnailUrl, Long authorId, Long ramenShopId) {
     ...
     */
    public static Post of(Long id, PostCategory category, String title, String content, String contentFormat,
            String thumbnailUrl, Long authorId, Long ramenShopId, int viewCount, LocalDateTime createdAt) {
        return Post.builder()
            .id(id)
            .category(category)
            .title(title)
