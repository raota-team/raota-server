...
public record AuthProperties(String issuer, String accessTokenSecret, long accessTokenExpirySeconds,
        long refreshTokenExpirySeconds, OAuth2 oauth2, Cookie cookie, Cors cors) {
