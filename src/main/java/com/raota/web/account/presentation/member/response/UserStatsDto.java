...
public class UserStatsDto {
    ...
    public UserStatsDto maskPrivate(ActivityVisibilityResponse visibility) {
        return new UserStatsDto(visibility.visits() ? visited_restaurant_count : null,
                visibility.logs() ? total_photo_count : null, visibility.logs() ? total_log_count : null,
                total_bookmark_count, visibility.posts() ? post_count : null,
