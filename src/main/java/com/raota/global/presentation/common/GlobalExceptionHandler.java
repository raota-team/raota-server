...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleAccessDenied(AccessDeniedException exception,
        ...
        log.warn("Access denied. method={}, uri={}, message={}", request.getMethod(), request.getRequestURI(),
    ...
    public ResponseEntity<ApiResponse<Void>> handleIllegalArgument(IllegalArgumentException exception,
            HttpServletRequest request) {
        log.warn("Illegal argument. method={}, uri={}, query={}, message={}", request.getMethod(),
                request.getRequestURI(), request.getQueryString(), exception.getMessage(), exception);
    ...
    public ResponseEntity<ApiResponse<Void>> handleIllegalState(IllegalStateException exception,
            HttpServletRequest request) {
        log.warn("Illegal state. method={}, uri={}, query={}, message={}", request.getMethod(), request.getRequestURI(),
                request.getQueryString(), exception.getMessage(), exception);
        return ResponseEntity.badRequest().body(ApiResponse.fail(exception.getMessage()));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleEntityNotFound(EntityNotFoundException exception,
            HttpServletRequest request) {
        log.warn("Entity not found. method={}, uri={}, query={}, message={}", request.getMethod(),
                request.getRequestURI(), request.getQueryString(), exception.getMessage(), exception);
    ...
    public ResponseEntity<ApiResponse<Void>> handleAiResponseFormat(AiResponseFormatException exception,
            HttpServletRequest request) {
        log.error("AI response could not be converted. method={}, uri={}", request.getMethod(), request.getRequestURI(),
                exception);
    ...
    public ResponseEntity<ApiResponse<Void>> handleMethodNotSupported(HttpRequestMethodNotSupportedException exception,
            HttpServletRequest request) {
        log.warn("Method not supported. method={}, uri={}, remoteAddr={}, userAgent={}, supportedMethods={}",
    ...
    public ResponseEntity<ApiResponse<Void>> handleMethodArgumentTypeMismatch(
        ...
        log.warn("Method argument type mismatch. method={}, uri={}, query={}, name={}, value={}", request.getMethod(),
                request.getRequestURI(), request.getQueryString(), exception.getName(), exception.getValue(),
                exception);
        return ResponseEntity.badRequest().body(ApiResponse.fail("잘못된 요청 파라미터입니다: " + exception.getName()));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleBindException(BindException exception, HttpServletRequest request) {
        ...
        log.warn("Bind exception. method={}, uri={}, query={}, field={}, rejectedValue={}", request.getMethod(),
                request.getRequestURI(), request.getQueryString(), fieldName, rejectedValue, exception);
        return ResponseEntity.badRequest().body(ApiResponse.fail("잘못된 요청 파라미터입니다: " + fieldName));
    }

    @ExceptionHandler(MethodArgumentNotValidException.class)
    public ResponseEntity<ApiResponse<Void>> handleMethodArgumentNotValid(MethodArgumentNotValidException exception,
            HttpServletRequest request) {
        String fieldName = exception.getBindingResult().getFieldError() == null ? "unknown"
                : exception.getBindingResult().getFieldError().getField();
        String message = "잘못된 요청 파라미터입니다: " + fieldName;
        log.warn("Request body validation failed. method={}, uri={}, message={}", request.getMethod(),
