...
class MemberProfileTest {
    ...
    void defaultRoleIsUser() {
        MemberProfile memberProfile = MemberProfile.builder().nickname("테스트").build();
    ...
    void fillEmailIfEmpty_KeepsExistingEmail() {
        MemberProfile memberProfile = MemberProfile.builder().nickname("테스트").email("member@example.com").build();
    ...
    void updateEmail() {
        MemberProfile memberProfile = MemberProfile.builder().nickname("테스트").email("old@example.com").build();
    ...
    void updateEmail_RejectsBlank() {
        ...
        assertThatThrownBy(() -> memberProfile.updateEmail(" ")).isInstanceOf(IllegalArgumentException.class)
